...
const defaultItems = [
  { icon: "🕯️", title: "Handmade", desc: "Fiecare lumânare este turnată manual cu grijă" },
  { icon: "🌿", title: "Ceară Naturală", desc: "Ceară de soia, fără parafină" },
  { icon: "🚚", title: "Livrare în toată România", desc: "În general, în 2-4 zile lucrătoare prin curier" },
