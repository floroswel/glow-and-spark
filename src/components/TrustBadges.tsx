...
const FALLBACK = [
  { id: "b1", icon: "ShieldCheck", title: "Plată securizată SSL", desc: "Conexiune criptată pentru protecția datelor", color: "#C9A24A", active: true },
  { id: "b2", icon: "RotateCcw", title: "Drept de retragere 14 zile", desc: "Conform legislației în vigoare", color: "#C9A24A", active: true },
  { id: "b3", icon: "Truck", title: "Livrare prin curier", desc: "În general, 2-4 zile lucrătoare", color: "#C9A24A", active: true },
  { id: "b4", icon: "Award", title: "Fabricat Artizanal", desc: "Produs manual în România", color: "#C9A24A", active: true },
];
