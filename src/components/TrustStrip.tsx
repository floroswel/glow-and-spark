...
const items = [
  {
    ...
    subtitle: "În general, 2-4 zile lucrătoare",
    to: "/page/transport-livrare",
  },
  {
    icon: RotateCcw,
    title: "Drept de retragere",
    subtitle: "14 zile calendaristice, conform legii",
    to: "/politica-returnare",
  },
  {
    icon: ShieldCheck,
    title: "Informații produse",
    subtitle: "Detalii în pagina fiecărui produs",
