...
export function WhatsAppButton() {
  ...
  // Only show if explicitly enabled AND a number is configured
  if (!general?.whatsapp_show || !general?.whatsapp_number) return null;

  const number = general.whatsapp_number;
