...
export const SETTINGS_REGISTRY: SettingDefinition[] = [
  ...
  def("general", "order_prefix", "string", "GS", "/admin/system", [], "Prefix număr comandă (folosit la generarea order_number în edge functions)", { internalOnly: true }),
  def("general", "order_email_notifications", "boolean", true, "/admin/system", [], "Trimite email confirmare comandă (consumat de send-email edge function)", { internalOnly: true }),
  def("general", "smtp_from_name", "string", "Mamalucica.ro", "/admin/system", [], "Nume expeditor email (edge functions)", { internalOnly: true }),
  def("general", "smtp_from_email", "string", "comenzi@mamalucica.ro", "/admin/system", [], "Email expeditor (edge functions)", { internalOnly: true }),
  def("general", "currency", "string", "RON", "/admin/system", [], "Moneda magazinului — RON hard-coded în UI; cheia rămâne pentru export/facturare", { internalOnly: true }),
