...
const defaultIntegrations: Integration[] = [
  ...
  { id: "netopia", name: "Netopia Payments", description: "Plăți online cu card. Cheile reale (NETOPIA_API_KEY, NETOPIA_POS_SIGNATURE, NETOPIA_PUBLIC_KEY, NETOPIA_ENV) se configurează DOAR în Supabase Edge Function Secrets — formularul de mai jos NU le persistă pentru runtime. Folosește pagina Metode de plată → Test Netopia pentru diagnostic.", icon: "💳", category: "Plăți", status: "disconnected", configFields: [{ key: "info", label: "Setează cheile în Supabase Secrets, nu aici", type: "text" }] },
