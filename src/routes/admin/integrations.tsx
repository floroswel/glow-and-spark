...
const defaultIntegrations: Integration[] = [
  ...
  { id: "ga4", name: "Google Analytics 4", description: "Analiză trafic și conversii", icon: "📊", category: "Analytics", status: "disconnected", configFields: [{ key: "measurement_id", label: "Measurement ID", type: "text" }] },
